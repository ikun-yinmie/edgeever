...
export const enUS = {
  ...
  sharedPane: {
    ...
    subtitle: "Notebooks and notes your groups share with you",
    sectionSharedWithMe: "Shared with me",
    sectionMyShares: "Shared by me",
    shareToGroup: "Share to group",
    emptyShared: "Nobody has shared anything with you yet. Ask an administrator to add you to a group under System administration → Groups.",
    emptyGroup: "Nothing is shared in this group yet.",
    emptyMyShares: "You have not shared anything with a group yet.",
    groupMeta: "{{members}} members · {{shares}} shared items",
    notebookMeta: "{{count}} notes",
    notebookEmpty: "This notebook has no notes yet.",
    fromAuthor: "from {{name}}",
    readOnly: "Read only",
    canEdit: "Can edit",
    editPolicy: "Editing rights",
    revoke: "Remove share",
    policyAuthor: "Only I can edit",
    policyGroup: "Everyone in the group can edit",
    policySelected: "Selected members can edit",
    policyTitle: "Editing rights",
    policyDescription: "Decide who may change this shared item. Everyone else can only read it.",
    whoCanEdit: "Who can edit",
    editAuthor: "Only me",
    editAuthorHint: "Everyone else can read it but not change it.",
    editGroup: "Group members",
    editGroupHint: "Group members can edit it; leave every box unchecked to allow the whole group.",
    chooseEditors: "Members who may edit",
    chooseEditorsHint: "With nobody selected, the whole group can edit.",
    savePolicy: "Save rights",
    shareDialogTitle: "Share to a group",
    shareDialogDescription: "Share a notebook (with everything nested underneath) or a single note with a group; every member can see it.",
    chooseGroup: "Choose a group",
    chooseContent: "Choose what to share",
    contentNotebook: "Notebook",
    contentMemo: "Single note",
    searchPlaceholder: "Search by name",
    noGroups: "You are not in a group yet. Ask an administrator to add you under System administration → Groups.",
    alreadyShared: "This item is already shared with that group.",
    shareSubmit: "Share",
    sharing: "Sharing...",
  ...
  groups: {
    title: "Groups",
    description: "Create groups and add members; members can share their own notebooks and notes into the group.",
    create: "New group",
    createTitle: "New group",
    createDescription: "Groups share notes with a set of people. You can add or remove members at any time.",
    name: "Group name",
    descriptionLabel: "Description (optional)",
    empty: "No groups yet — create the first one.",
    selectHint: "Pick a group on the left to review its members and shares.",
    groupMeta: "{{members}} members · {{shares}} shared items",
    members: "Members",
    manager: "Manager",
    addMember: "Add member",
    addMemberTitle: "Add members to {{group}}",
    addMemberDescription: "Members immediately see the notebooks and notes shared in the group.",
    noCandidates: "Nobody left to add — every member already belongs to this group.",
    shares: "Shared items",
    noShares: "Nothing is shared in this group yet. Members add items under Shared with me → Share to group.",
    delete: "Delete group",
  },
  myInvite: {
    title: "My invite code",
    description: "Generate an invite code to hand to someone who wants to join. You can copy it at any time, but it only works once.",
    generate: "Generate my invite code",
    generating: "Generating...",
    generateHint: "Each member holds a single invite code, so share it carefully.",
    statusUnused: "Unused",
    statusUsed: "Used",
    unusedHint: "Copy it and send it over — it stops working as soon as the other person registers.",
    usedHint: "This invite code has already been used and cannot be regenerated. Ask an administrator to reset it.",
    registrationHint: "This instance does not require an invite code to register, so your code has no effect yet.",
  },
  users: {
    title: "Members",
    ...
    descriptionList: "Search, bulk enable/disable, archive or delete member accounts. Administrator accounts and your own account are never touched in bulk.",
    searchPlaceholder: "Search username, display name or email",
    filterAll: "All",
    bulkHint: "Select members to run a bulk action",
    bulkEnable: "Enable",
    bulkDisable: "Disable",
    bulkArchive: "Archive",
    bulkRestore: "Restore",
    selectedCount: "{{count}} members selected",
    selectAll: "Select members on this page",
    columnMember: "Member",
    columnRole: "Role",
    columnStatus: "Status",
    ...
    editDescription: "Change the sign-in username, display name or email. Leave a field blank to keep it unchanged.",
    email: "Email",
    emailPlaceholder: "Optional, for example alex@example.com",
    emailHint: "Leave blank to keep this account free of an email address.",
    usernameEditHint: "The sign-in username may only contain letters, numbers, dashes and underscores.",
    emailExists: "That email address is already attached to another account.",
    saving: "Saving...",
    delete: "Delete account",
    deleteTitle: "Delete “{{username}}”?",
    deleteDescription: "This member's notes, attachments and Trash are removed permanently, and the account can no longer sign in. This cannot be undone.",
    deleteConfirm: "Delete permanently",
    deleting: "Deleting...",
    empty: "No member account matches.",
  ...
  register: {
    ...
    subtitle: "Register a new EdgeEver account",
    username: "Username",
    displayName: "Display name (optional)",
    email: "Email",
    emailCode: "Email verification code",
    inviteCode: "Invite code",
    inviteCodeHint: "Ask the administrator for an invite code — it is required to register.",
    ...
    errors: {
      ...
      username_or_email_exists: "This username or email is already registered.",
      email_code_invalid: "Incorrect verification code. Please try again.",
      email_code_expired: "The verification code has expired. Please request a new one.",
      smtp_not_configured: "Email delivery is not configured by the administrator.",
      email_delivery_failed: "Failed to send the verification email. Please try again later.",
      rate_limited: "Too many attempts. Please try again later.",
      invite_required: "This instance requires an invite code to register.",
      invite_invalid: "This invite code is invalid, used up or expired.",
      email_domain_blocked: "This email domain is not allowed to register.",
      email_domain_not_allowed: "This email is not on the registration allowlist.",
    },
  },
  adminConsole: {
    title: "System administration",
    pageTitle: "System administration",
    pageSubtitle: "Site-wide settings for administrators only",
    ...
    messagesCardDescription: "Public messages visitors see. Changes apply right away.",
    emailInactiveHint: "Email verification is currently off for registration; these settings are saved but stay inactive.",
    registrationSection: "User registration",
    registrationEnabled: "Allow user registration",
    registrationEnabledHint: "Let visitors create accounts from the sign-in page.",
    registrationCodeRequired: "Require email verification code",
    registrationCodeRequiredHint: "Registrations must confirm their email with a verification code.",
    inviteRequired: "Require an invite code",
    inviteRequiredHint: "Only visitors with a valid invite code can register.",
    emailPolicySection: "Email restrictions",
    emailAllowlistEnabled: "Only allow allowlisted emails",
    emailAllowlistEnabledHint: "When enabled, only the listed emails or domains can register. Add at least one entry, otherwise nobody can register.",
    emailAllowlist: "Allowed emails or domains (one per line)",
    emailBlocklist: "Blocked emails or domains (one per line)",
    emailPolicyHint: "Accepts full addresses (name@example.com) and domains (example.com, subdomains included). The blocklist always wins; leave empty for no restriction.",
    codePolicySection: "Verification code policy",
    codeTtlSeconds: "Code lifetime (seconds)",
    codeResendCooldownSeconds: "Resend cooldown (seconds)",
    codePolicyHint: "Default lifetime is 60 seconds. During the cooldown an email cannot request another code.",
    codeBindIp: "Bind code to the requesting IP",
    codeBindIpHint: "Registration must come from the same network that requested the code.",
    codeBindDevice: "Bind code to the requesting device",
    codeBindDeviceHint: "Registration must come from the same device that requested the code.",
    abuseSection: "Abuse protection",
    abuseGuardEnabled: "Enable endpoint abuse protection",
    abuseGuardEnabledHint: "Limit how often one network can request codes and register.",
    codeIpHourlyLimit: "Max code requests per IP per hour",
    codeIpDailyLimit: "Max code requests per IP per day",
    abuseHint: "Requests over the limit get 429. Counters live in server memory and reset when the container restarts.",
    smtpSection: "Email delivery (SMTP)",
    smtpHost: "SMTP server",
    smtpPort: "Port",
    smtpUsername: "Username",
    smtpPassword: "Password / app password",
    smtpPasswordPlaceholder: "Leave empty to keep the current one",
    smtpFromAddress: "From address",
    smtpFromName: "From name (optional)",
    smtpSecureHint: "Port 465 uses implicit SSL/TLS; port 587 usually uses STARTTLS.",
    messagesSection: "Custom messages",
    shareMissingMessage: "Missing share message",
    shareMissingMessagePlaceholder: "Leave empty for the default message, e.g. This note is no longer shared.",
    shareMissingMessageHint: "Shown to visitors who open a missing or revoked share link.",
    invites: {
      ...
      registrationClosedHint: "Heads up: user registration is currently off, so invite codes have no effect. Turn registration on under \"Registration\".",
      note: "Note (optional)",
      notePlaceholder: "e.g. for Alex",
      maxUses: "Allowed uses",
      expiresInDays: "Valid days",
      expiresNeverHint: "Leave empty to never expire.",
      create: "Generate invite",
      creating: "Generating...",
      createdLabel: "New invite code (shown once — copy it now)",
      copy: "Copy",
      copied: "Copied",
      revoke: "Revoke",
      revoking: "Revoking...",
      ...
      tabActive: "Active",
      tabRevoked: "Revoked",
      columnCode: "Invite code",
      columnSource: "Source",
      columnNote: "Note",
      columnUsage: "Usage",
      columnActions: "Actions",
      sourceAdmin: "Administrator",
      sourceUser: "Member · {{name}}",
      codeUnavailable: "Legacy code",
      ...
      createLocked: "Turn on \"Require an invite code to register\" above to generate new codes. Existing codes can always be revoked, restored or deleted.",
      emptyActive: "No usable invite codes.",
      emptyRevoked: "No revoked invite codes in the bin.",
      usedBy: "Used by {{name}}",
      memberCodeHint: "Members can each generate one invite code under Settings → Account. A member code works once; delete it to let that member create a new one.",
    },
    save: "Save",
    saving: "Saving...",
    saved: "Saved",
